...
class Agent{
    public:
        ...
        main_pub = nh.advertise<test_2_service::agent>("agent_test", 1000);
        ...
        sync.registerCallback(boost::bind(&Agent::callback,_1,_2,_3));
};
...
void Agent::callback(const test_2_service::string::ConstPtr& chatter_1 , const test_2_service::string::ConstPtr& chatter_2 , const lidar_2020::Ranging_alert::ConstPtr& lidar_msg){
